 ...
 * @author  Phil Sager
 */
public class AspectJPluginGroup extends SystemAction implements Presenter.Menu, Presenter.Popup, Presenter.Toolbar {
    ...
    public String getName() {
        return NbBundle.getMessage(AspectJPluginGroup.class, "LBL_GroupAction");
    }
    ...
    public HelpCtx getHelpCtx() {
        ...
        // return new HelpCtx (AspectJPluginGroup.class);
    }
    ...
    private static SystemAction[] grouped() {
        return new SystemAction[] {
                                    SystemAction.get(AspectJPluginBrowser.class),
                                    SystemAction.get(AspectJPluginBuild.class)};
    ...
    public JMenuItem getMenuPresenter() {
        ...
        if (icon == null) icon = new ImageIcon(AspectJPluginGroup.class.getResource(iconResource()));
        menu.setIcon(icon);
